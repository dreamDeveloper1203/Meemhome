...
class ProductController extends Controller
{
    public function index(Request $request)
    {
        ...
        $totalRecords = Product::select('count(*) as allcount')->where('parent_id', null)->count();   // Total records
        $iTotalDisplayRecords = Product::select('count(*) as allcount')->where('parent_id', null)->search($searchValue)->count();

        // Fetch records
        $records = Product::with('category', 'variants')
