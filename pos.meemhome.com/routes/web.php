...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/quotations/{quotation}', [\App\Http\Controllers\QuotationController::class, 'update'])->name('quotations.update');
    Route::delete('/quotations/{quotation}', [\App\Http\Controllers\QuotationController::class, 'destroy'])->name('quotations.destroy');
    Route::get('/quotations/getInvoice/{orderID}', [\App\Http\Controllers\QuotationController::class, 'getInvoice'])->name('quotations.getInvoice');
