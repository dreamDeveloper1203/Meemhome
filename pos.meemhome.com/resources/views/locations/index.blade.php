...
@section('content')
    <div class="d-flex align-items-center justify-content-center mb-3">
        <div class="flex-grow-1">
            <x-page-title>@lang('Locations')</x-page-title>
        </div>
    ...
    <x-card>
        <x-table id="locations-table">
            <x-thead>
                <tr>
                    <x-th>@lang('Location Name')</x-th>
...
@push('script')
    <script>
        $(document).ready(function() {
            let dataTable = $('#locations-table').DataTable({
                processing: true,
                serverSide: true,
                language: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        data: function(data, type, dataToSet) {
                            ...
                            var deleteUrl = "{{ route('locations.destroy', ':id') }}";
