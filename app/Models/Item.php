...
class Item extends Model
{
    ...
    {
        return $this->hasMany(Item::class, 'parent_id')->whereNull('deleted_at');
    }

    public function siblings()
    {
        return $this->hasMany(Item::class, 'parent_id', 'parent_id')->where('id', '!=', $this->id)->whereNull('deleted_at');
    }
