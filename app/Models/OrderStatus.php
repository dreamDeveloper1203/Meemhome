...
class OrderStatus extends Model
{
    ...
    const DELIVERED = 2;
    const CANCELLED = 3;
    const COMPLETED = 4; // New status constant
    ...
    public static $statuses = [
        ...
        self::COMPLETED => 'Completed', // New status label
    ];
    ...
    public static $icons = [
        ...
        self::COMPLETED => '<span class="material-symbols-sharp fs-6">done</span>', // New status icon
    ];
    ...
    public static $userIcons = [
        ...
        self::COMPLETED => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hero-icon-sm me-1"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>', // New status SVG icon
    ];
    ...
    public static $colors = [
        ...
        self::COMPLETED => 'bg-info', // New status color
    ];
